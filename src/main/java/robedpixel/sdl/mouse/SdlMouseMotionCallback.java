...
public class SdlMouseMotionCallback implements AutoCloseable {
    ...
    private static final FunctionDescriptor callbackHandleDescriptor =
            FunctionDescriptor.ofVoid(ValueLayout.ADDRESS,ValueLayout.JAVA_LONG,ValueLayout.ADDRESS,ValueLayout.JAVA_INT,ValueLayout.ADDRESS,ValueLayout.ADDRESS);
     ...
     * @param utimeStamp (unsigned long) The associated time at which this mouse motion event was received.
     ...
     */
    void callback(MemorySegment userData,long utimeStamp, MemorySegment window, int mouseId, MemorySegment x, MemorySegment y) {}
