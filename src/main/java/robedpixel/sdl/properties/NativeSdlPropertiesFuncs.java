        ...
        SDL_SetPointerPropertyWithCleanup =
                Linker.nativeLinker()
                        .downcallHandle(
                                ...
                                FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN,ValueLayout.JAVA_INT, ValueLayout.ADDRESS,ValueLayout.ADDRESS, ValueLayout.ADDRESS,ValueLayout.ADDRESS));
        SDL_SetPointerProperty =
                Linker.nativeLinker()
                        .downcallHandle(
                                library.find("SDL_SetPointerProperty").orElseThrow(),
                                FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN,ValueLayout.JAVA_INT, ValueLayout.ADDRESS,ValueLayout.ADDRESS));
        ...
        SDL_SetNumberProperty =
                Linker.nativeLinker()
                        .downcallHandle(
                                ...
                                FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN,ValueLayout.JAVA_INT, ValueLayout.ADDRESS,ValueLayout.JAVA_LONG));
        SDL_SetFloatProperty =
                Linker.nativeLinker()
                        .downcallHandle(
                                library.find("SDL_SetFloatProperty").orElseThrow(),
                                FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN,ValueLayout.JAVA_INT, ValueLayout.ADDRESS,ValueLayout.JAVA_FLOAT));
        SDL_SetBooleanProperty =
                Linker.nativeLinker()
                        .downcallHandle(
                                library.find("SDL_SetBooleanProperty").orElseThrow(),
                                FunctionDescriptor.of(ValueLayout.JAVA_BOOLEAN,ValueLayout.JAVA_INT, ValueLayout.ADDRESS,ValueLayout.JAVA_BOOLEAN));
        SDL_HasProperty =
                Linker.nativeLinker()
                        .downcallHandle(
        ...
        SDL_GetFloatProperty =
                Linker.nativeLinker()
                        .downcallHandle(
                                ...
                                FunctionDescriptor.of(ValueLayout.JAVA_FLOAT,ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_FLOAT));
