...
public class SdlGamepadAxisEvent {
  ...
  /** The gamepad axis (SDLGamepadAxis) */
  @Getter byte axis;
  ...
  public static SdlGamepadAxisEvent getEventFromMemorySegment(MemorySegment segment) {
    SdlGamepadAxisEvent retEvent = new SdlGamepadAxisEvent();
