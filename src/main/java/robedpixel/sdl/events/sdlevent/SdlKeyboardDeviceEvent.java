...
public class SdlKeyboardDeviceEvent {
    public static final StructLayout objectLayout =
            MemoryLayout.structLayout(
                    ...
                    .withName("SDL_KeyboardDeviceEvent");
    ...
    public static SdlKeyboardDeviceEvent getEventFromMemorySegment(MemorySegment segment) {
        SdlKeyboardDeviceEvent retEvent = new SdlKeyboardDeviceEvent();
