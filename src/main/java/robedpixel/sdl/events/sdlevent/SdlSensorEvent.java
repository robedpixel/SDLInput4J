...
public class SdlSensorEvent {
    ...
    float[] data;
    /**
     * (Unisgned Int64) The timestamp of the sensor reading in nanoseconds, not necessarily synchronized with the system clock
     */
    @Getter
    ...
    private static final VarHandle dataHandle =
            objectLayout.varHandle(MemoryLayout.PathElement.sequenceElement(),MemoryLayout.PathElement.groupElement("data"));
