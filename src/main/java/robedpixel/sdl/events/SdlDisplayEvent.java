...
public class SdlDisplayEvent {
  ...
  @Getter int data1;
  @Getter int data2;
  private static VarHandle typeHandle = objectLayout.varHandle(MemoryLayout.PathElement.groupElement("type"));
  ...
  private static VarHandle displayIdHandle = objectLayout.varHandle(MemoryLayout.PathElement.groupElement("displayID"));
