...
public class SdlScancode {
   ...
   * both of those codes and your OS treats them differently; you should generate public static
   * final int SDL_SCANCODE_BACKSLASH instead of this code. As a user; you should not rely on this
   * code because public static final int SDL will never generate it with most (all?) keyboards.
   */
   ...
   * public static final int SDL_KMOD_MODE for it I'm adding it here
   */
  ...
  /* @{ */
  /** < Sleep */
  public static final int SDL_SCANCODE_SLEEP = 258;

  /** < Wake */
  public static final int SDL_SCANCODE_WAKE = 259;

  /** < Channel Increment */
  public static final int SDL_SCANCODE_CHANNEL_INCREMENT = 260;

  /** < Channel Decrement */
  public static final int SDL_SCANCODE_CHANNEL_DECREMENT = 261;

  /** < Play */
  public static final int SDL_SCANCODE_MEDIA_PLAY = 262;

  /** < Pause */
  public static final int SDL_SCANCODE_MEDIA_PAUSE = 263;

  /** < Record */
  public static final int SDL_SCANCODE_MEDIA_RECORD = 264;

  /** < Fast Forward */
  public static final int SDL_SCANCODE_MEDIA_FAST_FORWARD = 265;

  /** < Rewind */
  public static final int SDL_SCANCODE_MEDIA_REWIND = 266;

  /** < Next Track */
  public static final int SDL_SCANCODE_MEDIA_NEXT_TRACK = 267;

  /** < Previous Track */
  public static final int SDL_SCANCODE_MEDIA_PREVIOUS_TRACK = 268;

  /** < Stop */
  public static final int SDL_SCANCODE_MEDIA_STOP = 269;

  /** < Eject */
  public static final int SDL_SCANCODE_MEDIA_EJECT = 270;

  /** < Play / Pause */
  public static final int SDL_SCANCODE_MEDIA_PLAY_PAUSE = 271;

  /** Media Select */
  public static final int SDL_SCANCODE_MEDIA_SELECT = 272;

  /** < AC New */
  public static final int SDL_SCANCODE_AC_NEW = 273;

  /** < AC Open */
  public static final int SDL_SCANCODE_AC_OPEN = 274;

  /** < AC Close */
  public static final int SDL_SCANCODE_AC_CLOSE = 275;

  /** < AC Exit */
  public static final int SDL_SCANCODE_AC_EXIT = 276;

  /** < AC Save */
  public static final int SDL_SCANCODE_AC_SAVE = 277;

  /** < AC Print */
  public static final int SDL_SCANCODE_AC_PRINT = 278;

  /** < AC Properties */
  public static final int SDL_SCANCODE_AC_PROPERTIES = 279;

  /** < AC Search */
  public static final int SDL_SCANCODE_AC_SEARCH = 280;

  /** < AC Home */
  public static final int SDL_SCANCODE_AC_HOME = 281;

  /** < AC Back */
  public static final int SDL_SCANCODE_AC_BACK = 282;

  /** < AC Forward */
  public static final int SDL_SCANCODE_AC_FORWARD = 283;

  /** < AC Stop */
  public static final int SDL_SCANCODE_AC_STOP = 284;

  /** < AC Refresh */
  public static final int SDL_SCANCODE_AC_REFRESH = 285;

  /** < AC Bookmarks */
  public static final int SDL_SCANCODE_AC_BOOKMARKS = 286;
  ...
  public static final int SDL_SCANCODE_RESERVED = 400;
