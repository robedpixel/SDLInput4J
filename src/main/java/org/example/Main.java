...
public class Main {
    public static void main(String[] args){
        ...
        try(NativeSdlLib sdlLib = new NativeSdlLib(SdlInitFlagsFactory.SDLFlagValue.SDL_INIT_GAMEPAD, SdlInitFlagsFactory.SDLFlagValue.SDL_INIT_VIDEO)){
            System.out.println(sdlLib.isMainThread());
            SdlVideo video = sdlLib.getSdlVideo();
            SdlDisplayIdArray array = video.getDisplays();
            SdlError error = sdlLib.getSdlError();
